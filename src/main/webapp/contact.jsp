...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>联系我们-首页</title>
	<meta name="keywords" content="联系我们,首页" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<!-- LOGO -->
			...
			<a href="http://www.shmrmjsj.com/www_shmrmjsj_default.html"><img src="http://cdn057.yun-img.com/static/upload/shmrmjsj/logo/20180306111046_94023.png" alt=""  style="width:447.36364px;height:71.36364px;"></a>
		</div>
				<!-- LOGO end -->
		<div class="m-hd-top">
		<!--是否显示整体注册条-->
		<div class="m-head-regist">
									<a class="u-hd-btn" href="contact.jsp#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="contact.jsp#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="contact.jsp#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
...
<!-- 模块 end  duangou-->
<!-- 新闻列表(专用) -->
<div class="m-wg m-default m-default-default  " id="visualmodule_11" style='width:244.181818px;height:auto;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:676px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 列表start -->
		<div class="m-theme61">
			<ul>
		...
		<div class="m-theme15" id="m-theme15">
			<ul>
								...
								<li  class='noline'>
					<a class='u-parent' href="product_398952.html#visualmodule_10"> 塑料产品</a>
				</li>
												    										<li><a class='u-child' href="product_398952_400042.html#visualmodule_10"> 荣泰</a></li>
										<li><a class='u-child' href="product_398952_407106.html#visualmodule_10"> 大风</a></li>
										<li><a class='u-child' href="product_398952_400044.html#visualmodule_10"> 乔山</a></li>
										<li><a class='u-child' href="product_398952_400041.html#visualmodule_10"> QBD</a></li>
													
								
				
																
								<li >
					<a class='u-parent' href="product_398953.html#visualmodule_10"> 模具</a>
				</li>
...
<div class="m-wg m-default m-default-default  " id="visualmodule_14" style='width:752px;height:72px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:10px;margin-right:0px;margin-top:40px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
	...
	<div style="position:absolute;right:0px;top:8px;height:46px;color:#666666;font-size:12px;line-height:46px;">
		<span style="font-size:12px;color:#666666;">当前位置：</span><a href="http://www.shmrmjsj.com/index.htm" title="首页" style="color:#666;">首页</a> &gt; <span style="font-size:12px;color:#155b9d;">联系我们 </span> 
	</div>
</div></div>
	</div>
</div>
<!-- 模块 end  duangou-->
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_15" style='width:747px;height:212px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
...
<div class="m-wg m-default m-default-default  " id="visualmodule_16" style='width:750px;height:440px;' data-wow-duration=3s data-wow-delay=1>
		<div class="m-wg-ct">
		<div class="m-theme30">
		</div>
		<style>
...
<script src="http://api.map.baidu.com/api?v=2.0&amp;ak=2Ob1Cq4Ox2VLz1Dz1SHoHyjhECGsNWPr"></script>
<div id="m-baidu-map"></div>        
<script type="text/javascript">
// 创建地图
var map = new BMap.Map("m-baidu-map");
// 创建需要显示信息框
var mapBoxShow = '<p title="上海铭瑞模具有限公司" style="width:300px;display:block;font:bold 14px/16px arial,simsun,sans-serif;margin-bottom:5px;color:#cc5522;white-space:nowrap;overflow:hidden">上海铭瑞模具有限公司</p>' + 
                "<p style='padding-right:10px;width:100%;word-break: break-all;font-size: 14px;'>地址：上海市嘉定区立新路8号</p>" +
                "<p style='padding-right:10px;width:220px;word-break: break-all;font-size: 14px;'>电话：021-59512559</p>" +
                "" +
                "</div>";
// 增加左侧控制条
...
myLocalsearch.search('上海市嘉定区立新路8号');
</script>
			</div>
</div>
