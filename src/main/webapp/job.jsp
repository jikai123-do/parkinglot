...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>招聘中心-首页</title>
	<meta name="keywords" content="招聘中心,首页" />
	<meta name="description" content="招聘中心-首页" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<div class="m-head-regist">
									<a class="u-hd-btn" href="job.jsp#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="job.jsp#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="job.jsp#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
...
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_3" style='width:1419px;height:65px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:-211px;margin-right:0px;margin-top:0px;margin-bottom:0px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
		<style type='text/css' class='m-wg-ct-style'>#visualmodule_3 .m-wg-ct{font-family:inherit;background-image:url(http://cdn033.yun-img.com/static/upload/a00650y/visualtoolkit/20170215172457_62886.png);background-repeat:repeat;padding-top:10px;padding-bottom:10px;}</style>	<div class="m-wg-ct">
...
<table style="width:100%;" cellpadding="2" cellspacing="0" class="ke-zeroborder">
	<tbody>
		<tr>
			...
			<td>
				<a href="http://www.shmrmjsj.com/custom650511.html"><button class="button button1"><strong>技工类</strong></button> </a> 
			</td>
			<td>
				<a href="http://www.shmrmjsj.com/custom650512.html"><button class="button button1"><strong>技术类</strong></button> </a> 
			</td>
			<td style="width:70%;">
				<br />
			</td>
...
<!-- 模块 end  duangou-->
<!-- 招聘中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_4" style='width:1166px;height:auto;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:-85px;margin-right:0px;margin-top:20px;margin-bottom:30px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 列表start -->
		<div class="m-theme130">
						<div class="m-theme130-inner">
				<div class='m-title'>塑料模具钳工</div>
				<div class="m-theme130-txt">
					<p class='u-title'>一、职位要求：</p>
					<div class='m-theme130-content'><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">要求：</span></div><span style="color: rgb(68, 68, 68); white-space: normal; font-size: 16px; font-family: 宋体, SimSun;">1.2年以上塑胶模具工作经验，熟练操作车床，放电，磨床、铣床等</span><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">2.能够适应加班，吃苦耐劳</span></div><p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-family: 宋体, SimSun;"></span><br/></p><p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><br/></p><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">待遇：底薪4800-6000，综合工资6000-8000. 做六休一，包吃。 加班时间一般是18：00-21：00。</span></div><p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><br/></p><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">上海铭瑞模具有限公司</span></div><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">上海市嘉定区立新路8号</span></div><div style="margin: 0px; padding: 0px; line-height: 2em; color: rgb(68, 68, 68); font-family: "Microsoft Yahei", arial, verdana, helvetica, sans-serif; white-space: normal;"><span style="font-size: 16px; font-family: 宋体, SimSun;">电话：18016406006 &nbsp;021-59512559</span></div></div>
				</div>
				<div class="m-theme130-txt">
					<p class='u-title'>二、工作职责：</p>
					<div class='m-theme130-content'><span style="color: rgb(68, 68, 68); font-family: 宋体, SimSun; font-size: 16px; white-space: normal;">熟练操作车床，放电，磨床、铣床。加工塑胶模具。</span></div>
				</div>
							</div>
							
			<div class='f-clear'></div>
			<div class='m-paginator'><ul class="paginator"><li class='u-totalnum'>1/2</li><li class="current">1</li><li><a href='http://www.shmrmjsj.com/job_2.html#visualmodule_4'>2</a></li><li><a href='http://www.shmrmjsj.com/job_2.html#visualmodule_4'> › </a></li><li><a href='http://www.shmrmjsj.com/job_2.html#visualmodule_4'> » </a></li></ul><div class='m-paginator-search'><span class='standard_select'><span class='select_shelter'><select onchange='self.location.href=options[selectedIndex].value' class='paginator-make'><option selected='selected' value='/job.html?page=1#visualmodule_4'>1</option><option value='/job.html?page=2#visualmodule_4'>2</option></select></span></span></div></div>
		</div>
		<!-- 列表end -->
