...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>产品展示-首页</title>
	<meta name="keywords" content="产品展示,首页" />
	<meta name="description" content="产品展示-首页" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<div class="m-head-regist">
									<a class="u-hd-btn" href="product.jsp#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="product.jsp#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="product.jsp#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
...
<!-- 模块 end  duangou-->
<div class="m-wg m-default m-default-default  " id="visualmodule_11" style='width:243.181818px;height:166.181818px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:676px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 列表start -->
		<div class="m-theme2">
				<ul>
...
<div class="m-wg m-default m-default-default  " id="visualmodule_14" style='width:752px;height:72px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:10px;margin-right:0px;margin-top:40px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
	...
	<div style="position:absolute;right:0px;top:8px;height:46px;color:#666666;font-size:12px;line-height:46px;">
		<span style="font-size:12px;color:#666666;">当前位置：</span><a href="http://www.shmrmjsj.com/index.htm" title="首页" style="color:#666;">首页</a> &gt; <span style="font-size:12px;color:#155b9d;">产品展示</span> 
	</div>
</div></div>
	</div>
</div>
<!-- 模块 end  duangou-->
<!-- 普通中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_15" style='width:746px;height:auto;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 图片栏目 -->
		<div class="m-theme1">
			<div class='f-clear'></div>
						<div class='f-clear'></div>
			<div class='m-paginator'><ul class="paginator"><li class='u-totalnum'>1/1</li><li class="current">1</li></ul><div class='m-paginator-search'><span class='standard_select'><span class='select_shelter'><select onchange='self.location.href=options[selectedIndex].value' class='paginator-make'><option selected='selected' value='/product.html?page=1#visualmodule_15'>1</option></select></span></span></div></div>
		</div>
		<!-- 图片栏目 end -->
	</div>
</div>
