...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>关于我们-首页</title>
	<meta name="keywords" content="关于我们,首页" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<div class="m-head-regist">
									<a class="u-hd-btn" href="about.jsp#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="about.jsp#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="about.jsp#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
...
<!-- 全部产品end     -->        
    ...
    <div class="navCont_s" style="margin:0; width:1180px;">
        ...
        <ul id="coreNav" class="navList">
					...
					<li class="active"> 
            								<a  class="first-a" href="product.html" >产品展示</a>
				                        			            </li>
					<li class="active"> 
            								<a  class="first-a" href="album_21805.html" >公司风采</a>
				                        			            </li>
					<li class="active"> 
            								<a  class="first-a" href="group.html" >业务中心</a>
				                        			            </li>
					<li class="active"> 
            								<a  class="first-a" href="news.html" >新闻资讯</a>
				                        			            </li>
					<li class="active"> 
            								<a  class="first-a" href="job.html" >招聘中心</a>
				                        			            </li>
					<li class="active"> 
...
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_7" style='width:246px;height:68px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:0px;margin-right:0px;margin-top:20px;margin-bottom:50px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
		<style type='text/css' class='m-wg-ct-style'>#visualmodule_7 .m-wg-ct{font-family:inherit;background-image:url(http://cdn047.yun-img.com/static/upload/a00667y/visualtoolkit/20170515113646_40881.png);background-repeat:repeat;padding-bottom:80px;padding-top:20px;}</style>	<div class="m-wg-ct">
		<div class='m-theme28'><div style="width:230px;height:50px;padding-left:16px;color:#333333;font-size:22px;line-height:50px;background:#efefef;">
	产品展示<span>Category</span> 
</div></div>
	</div>
</div>
<!-- 模块 end  duangou-->
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_13" style='width:243.181818px;height:56.181818px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:620px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class='m-theme28'><div style="width:230px;height:54px;padding-left:14px;color:#333333;font-size:22px;line-height:54px;">
	新闻资讯<span>News</span> 
</div></div>
	</div>
</div>
<!-- 模块 end  duangou-->
<!-- 新闻列表(专用) -->
<div class="m-wg m-default m-default-default  " id="visualmodule_11" style='width:243.181818px;height:auto;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:676px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 列表start -->
		<div class="m-theme61">
			<ul>
		...
		<!-- 列表 end -->
		<div class='f-clear'></div>
		<div class='m-paginator'><ul class="paginator"><li class='u-totalnum'>1/1</li><li class="current">1</li></ul><div class='m-paginator-search'><span class='standard_select'><span class='select_shelter'><select onchange='self.location.href=options[selectedIndex].value' class='paginator-make'><option selected='selected' value='/about.html?page=1#visualmodule_11'>1</option></select></span></span></div></div>
	</div>
</div><!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_12" style='width:243.181818px;height:312.181818px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:295px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class='m-theme28'><div style="width:230px;height:54px;padding-left:14px;border-bottom:1px solid #d5d5d5;color:#333333;font-size:22px;line-height:54px;">
...
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">联系人：翁先生</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">手机：</span><span lang="EN-US"><span style="font-family:Microsoft YaHei;font-size:16px;">18016406006&nbsp;&nbsp;&nbsp; </span><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">电话：</span><span lang="EN-US"><span style="font-family:Microsoft YaHei;font-size:16px;">021-59512559</span><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">传真：</span><span lang="EN-US"><span style="font-family:Microsoft YaHei;font-size:16px;">021-39529033</span><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">邮箱：</span><span lang="EN-US"><span style="font-family:Microsoft YaHei;font-size:16px;">zlb52825@163.com</span><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">公司地址：上海市嘉定区立新路</span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">8</span><span style="font-family:Microsoft YaHei;font-size:16px;">号</span> 
</p>
<p>
	<br />
</p>
<p>
	<span><span style="font-family:Microsoft YaHei;font-size:16px;"></span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;"></span><span style="font-family:Microsoft YaHei;font-size:16px;"></span></span><span><span lang="EN-US"></span></span> 
</p>
<p>
	<br />
</p></div>
...
<!-- 模块 end  duangou-->
<div class="m-wg m-default m-default-default  " id="visualmodule_10" style='width:246px;height:204px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:-246px;margin-right:0px;margin-top:85px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
		<style type='text/css' class='m-wg-ct-style'>#visualmodule_10 .m-wg-ct{font-family:inherit;background-color:#36f;color:#FFFFFF;}#visualmodule_10 .m-wg-ct a{color:#FFFFFF;}</style>	<div class="m-wg-ct">
		<div class="f-clear"></div>
			<div class="m-theme250" id="m-theme250">
				
				<div class="theme250-main">
					
					<ul>
						                        							<li class="theme250-item">
							    								<div class="theme250-title">
									<h3><a href="product_398952.html">塑料产品</a></h3>
									<span><img src="static/newtheme/common/img/theme/theme250/jia.png" class="jt-jia"/></span>
								</div>
																<ul>
																											<li class="theme250-item-1">
										<a class='u-child' href="product_398952_400042.html#visualmodule_10"> 荣泰</a>
										<img src="static/img/team/product/theme2/jt-right.png" class="jt-right"/>
									</li>
																		<li class="theme250-item-1">
										<a class='u-child' href="product_398952_407106.html#visualmodule_10"> 大风</a>
										<img src="static/img/team/product/theme2/jt-right.png" class="jt-right"/>
									</li>
																		<li class="theme250-item-1">
										<a class='u-child' href="product_398952_400044.html#visualmodule_10"> 乔山</a>
										<img src="static/img/team/product/theme2/jt-right.png" class="jt-right"/>
									</li>
																		<li class="theme250-item-1">
										<a class='u-child' href="product_398952_400041.html#visualmodule_10"> QBD</a>
										<img src="static/img/team/product/theme2/jt-right.png" class="jt-right"/>
									</li>
																										</ul>
		...
		<script type="text/javascript">
		 window.onload = function(){
		    // 提取当前页面地址并分解出"/"后面的内容
		        ...
		        if(loc.lastIndexOf('#')!=-1){ //如果要检索的字符串值没有出现，则该方法返回 -1
		            loc = loc.substring(0, loc.lastIndexOf('#'));
		        }
		    ...
		    var el = [],
		        el = document.getElementById('m-theme250').getElementsByTagName('a');
		    ...
		    for (var i=0; i<el.length; i++ ) {
			 ...
			 /*伸缩*/
				  	$('.theme250-item span').click(function(){
						if($(this).parent().parent().find($('.theme250-item-1')).css('display')=='none'){
							$(this).parent().parent().find($('.theme250-item-1')).css('display','block');
			  				$(this).parent().parent().siblings().find($('.theme250-item-1')).css('display','none');
						}else{
							$(this).parent().parent().find($('.theme250-item-1')).css('display','none');
						}
						
				  		if(	$(this).parent().parent().find($('.theme250-item-1')).css('display') =='block'){
				  			$('.theme250-item span').find($('img')).attr('src','/static/newtheme/common/img/theme/theme250/jia.png');
				  			$(this).find($('img')).attr('src','/static/newtheme/common/img/theme/theme250/jian.png');
...
<div class="m-wg m-default m-default-default  " id="visualmodule_14" style='width:752px;height:72px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:10px;margin-right:0px;margin-top:40px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class='m-theme28'><div style="position:relative;width:100%;height:58px;border-bottom:1px solid #d0d0d0;">
	<div style="float:left;color:#333333;font-size:24px;line-height:52px;">
		关于我们
	</div>
	<div style="float:left;padding-left:10px;color:#006cae;font-size:18px;line-height:58px;font-family:arial;text-transform:uppercase;font-weight:normal;">
		about <span>us</span> 
	</div>
	<div style="position:absolute;right:0px;top:8px;height:46px;color:#666666;font-size:12px;line-height:46px;">
		<span style="font-size:12px;color:#666666;">当前位置：</span><a href="http://www.shmrmjsj.com/index.htm" title="首页" style="color:#666;">首页</a> &gt; <span style="font-size:12px;color:#155b9d;">关于我们</span> 
	</div>
</div></div>
	</div>
</div>
...
<!-- 公司简介模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_15" style='width:745px;height:370px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:10px;margin-right:0px;margin-top:20px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class="m-theme11"> 
...
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">上海铭瑞模具有限公司成立于</span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">2002</span><span style="font-family:Microsoft YaHei;font-size:16px;">年，座落于国际大都市</span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">---</span><span style="font-family:Microsoft YaHei;font-size:16px;">上海，公司将为您提供优质的模具设计，模具制造，注塑加工，塑胶模具加工等一系列服务。</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">目前，上海铭瑞模具有限公司拥有国内同行先进的设备和雄厚的技术力量： </span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">CNC</span><span style="font-family:Microsoft YaHei;font-size:16px;">数控铣床（</span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">1350*650*550</span><span style="font-family:Microsoft YaHei;font-size:16px;">）、精雕机、火花机、合模机、翻模机、铣床、磨床、线切割、车床、钻床等设备齐全。此外，我司在塑胶方面也有很大的优势，如今已有十台震雄注塑机（注塑机吨位</span><span lang="EN-US" style="font-family:Microsoft YaHei;font-size:16px;">88T-1300T</span><span style="font-family:Microsoft YaHei;font-size:16px;">）。</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">目前公司产品涉及通讯器材、汽车配件、家用电器、健身器材、健康科技等行业。</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">上海铭瑞模具有限公司拥有优秀的技术人才团队及先进的科学技术设备，每个产品的诞生都赋予我们团队的力量和创新精神，以严谨态度，注重精益求精为客户设计最完美的产品。我司始终严格贯彻执行五个观念：品质观念、成本观念、时间观念、效率观念、信誉观念，以此作为每个职员必备的作业准则，也是公司永续发展的基础。</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">为客户服务是我们的天职，我们会将服务进行到底！</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p class="MsoNormal" align="left" style="text-indent:21pt;">
	<span style="font-family:Microsoft YaHei;font-size:16px;">衷心希望与贵司建立良好的合作关系，共创美好未来！</span><span lang="EN-US"><o:p></o:p></span> 
</p>
<p>
	<br />
</p>
...
<!-- 模块 end --><div class='g-main-clear' style='clear:both'></div>
</div>
<!-- 拖拽980 -->
<!-- 脚部 -->
	...
	<tbody>
		<tr>
			...
			<td style="width:500px;">
				<span style="font-family:'Microsoft YaHei';font-size:12px;color:#6e6e6e;line-height:30px;"><a href="about.jsp">关于我们</a>｜<a href="product.html">产品展示</a>｜<a href="message.html">在线留言</a>｜<a href="/ contact.html" =""="">联系我们</a><br />
				<p>
