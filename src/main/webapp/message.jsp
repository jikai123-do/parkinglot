...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>在线留言-首页</title>
	<meta name="keywords" content="在线留言,首页" />
	<meta name="description" content="在线留言-首页" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<div class="m-head-regist">
									<a class="u-hd-btn" href="http://www.shmrmjsj.com/message.htm#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="http://www.shmrmjsj.com/message.htm#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="http://www.shmrmjsj.com/message.htm#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
	...
	<div class="bd">
		<ul>
						...
						<li _src="url(http://cdn1.qiyuntong.com/static/upload/a00288/focus/20140930085144_72753.jpg)">
											<a href="http://www.shmrmjsj.com/message.htm#"  alt="浪漫满屋"></a>
										</li>		
					</ul>
	</div>
...
<!-- 模块 end  duangou-->
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_12" style='width:244px;height:312px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:295px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
...
<!-- 模块 end  duangou-->
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_13" style='width:244px;height:56px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:620px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
...
<!-- 模块 end  duangou-->
<div class="m-wg m-default m-default-default  " id="visualmodule_11" style='width:244px;height:193px;float:left;border-style:solid;border-width:1px;border-color:#d5d5d5;margin-left:-246px;margin-right:0px;margin-top:676px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<!-- 列表start -->
		<div class="m-theme2">
				<ul>
...
</div><div class="m-wg m-default m-default-default  " id="visualmodule_10" style='width:246px;height:197px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:-246px;margin-right:0px;margin-top:85px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
...
<div class="m-wg m-default m-default-default  " id="visualmodule_14" style='width:752px;height:72px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:10px;margin-right:0px;margin-top:40px;margin-bottom:10px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
	...
	<div style="float:left;padding-left:10px;color:#006cae;font-size:18px;line-height:58px;font-family:arial;text-transform:uppercase;font-weight:normal;">
		Online<span> message</span> 
	</div>
	<div style="position:absolute;right:0px;top:8px;height:46px;color:#666666;font-size:12px;line-height:46px;">
		<span style="font-size:12px;color:#666666;">当前位置：</span><a href="http://www.shmrmjsj.com/index.htm" title="首页" style="color:#666;">首页</a> &gt; <span style="font-size:12px;color:#155b9d;">在线留言 </span> 
	</div>
</div></div>
	</div>
</div>
...
<div class="m-wg m-default m-default-default  " id="visualmodule_15" style='width:748px;height:553px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class="m-theme33">
			<div class='m-content'>
				<div class="u-tiptxt">
				非常感谢您使用我们网站！如果您有任何建议与意见，欢迎留言告诉我们。对于您在产品购买过程中发生问题，您也可以向我们反馈，我们将尽力为您解决问题。 								</div>
				<div class='m-theme33-form'>
				<form action="http://www.shmrmjsj.com/message.htm" method="post">
					...
					<div style="color:gray;">
					 	...
					 	<div class="files" style=" color:red; position:absolute; top:0px; left:90px;"></div>
					</div>
										<div class='f-clear'></div>
					<center>
...
$(function () {
	...
	$("#fileupload").wrap("<form id='myupload' action='http://www.shmrmjsj.com/webapi/kindupload.htm' method='post' enctype='multipart/form-data'></form>");
