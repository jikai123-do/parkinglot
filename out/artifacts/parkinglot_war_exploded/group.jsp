...
<head>
	...
	<meta charset="utf-8" />
				...
				<title>业务中心-首页</title>
	<meta name="keywords" content="业务中心,首页" />
	<meta name="description" content="业务中心-" />
...
<div class="g-hd-inner g-hd-limit" style="height:px;">
	<!-- 头部980 -->
		...
		<div class="m-head-regist">
									<a class="u-hd-btn" href="group.jsp#"  id='set_startpage' style="color:#000;">设为首页<!-- 设为首页 --></a>
									<a class="u-hd-btn" href="group.jsp#"  id='set_favorite' style="color:#000;">收藏本站<!-- 收藏本站 --></a>
									<a class="u-hd-btn u-trans" href="group.jsp#"  id='set_translation' style="color:#000;">简繁切换<!-- 简繁切换 --></a>
...
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_6" style='width:1010px;height:183px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:0px;margin-right:0px;margin-top:0px;margin-bottom:0px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
			<div class="m-wg-ct">
		<div class='m-theme28'><div style="text-align:center;">
	<img class='lazyload' data-original="http://cdn055.yun-img.com/static/upload/a00667y/visualtoolkit/20170515164155_90228.jpg" width="1000" height="180" alt="" /> 
</div></div>
	</div>
</div>
<!-- 模块 end  duangou-->
<!-- 站点公告中心模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_7" style='width:270px;height:265px;float:left;border-style:none;border-width:0px;border-color:#333333;margin-left:0px;margin-right:0px;margin-top:20px;margin-bottom:50px;padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;' data-wow-duration=3s data-wow-delay=1>
		<style type='text/css' class='m-wg-ct-style'>#visualmodule_7 .m-wg-ct{font-family:inherit;background-image:url(http://cdn047.yun-img.com/static/upload/a00667y/visualtoolkit/20170515113646_40881.png);background-repeat:repeat;padding-bottom:40px;padding-top:20px;}</style>	<div class="m-wg-ct">
...
<table background="http://cdn065.yun-img.com/static/upload/a00667y/visualtoolkit/20170515113458_43479.png" style="width:100%;background-repeat:repeat;" cellpadding="2" cellspacing="0" class="ke-zeroborder">
	<tbody>
		<tr>
			<td style="text-align:center;">
				<span style="font-size:24px;font-family:Microsoft YaHei;color:#000000;"><strong>业务中心</strong></span> 
			</td>
		</tr>
		<tr>
			<td style="text-align:center;">
				...
				<p>
					<span style="font-size:16px;font-family:Microsoft YaHei;color:#000000;">模具设计</span> 
				</p>
			</td>
		</tr>
		<tr>
			<td style="text-align:center;">
				...
				<p>
					<span style="font-size:16px;font-family:Microsoft YaHei;color:#000000;">模具制造</span> 
				</p>
			</td>
		</tr>
		<tr>
			<td style="text-align:center;">
				...
				<p>
					<span style="font-size:16px;font-family:Microsoft YaHei;color:#000000;">注塑加工</span> 
				</p>
			</td>
		</tr>
		<tr>
...
<!-- 公司简介模块 -->
<div class="m-wg m-default m-default-default  " id="visualmodule_13" style='width:729px;height:263px;' data-wow-duration=3s data-wow-delay=1>
		<style type='text/css' class='m-wg-hd-style'>#visualmodule_13 .m-wg-hd h2{font-family:inherit;}</style>	<div class="m-wg-hd">
		<h2>业务简介</h2>
			</div>
			<div class="m-wg-ct">
		<div class="m-theme11"> 
